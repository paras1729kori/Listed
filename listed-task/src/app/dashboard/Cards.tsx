...
import totalR from "../../../public/svgs/totalR.svg";
import likes from "../../../public/svgs/likes.svg";
import totalUsers from "../../../public/svgs/totalUsers.svg";

const Cards = () => {
  return (
    <section className="flex flex-col md:flex-row gap-2 md:gap-10 justify-between mt-10">
      <div className="md:w-1/4 p-5 md:p-10 bg-[#DDEFE0] rounded-[20px] flex flex-row-reverse justify-between md:flex-col">
        <div className="flex justify-end mb-5">
          <Image src={totalR} alt="totalR.svg" />
        </div>
        <div>
          <h2 className="text-lg mb-2">Total Revenues</h2>
          <h1 className="text-4xl font-bold">$2,129,430</h1>
        </div>
      </div>

      <div className="md:w-1/4 p-5 md:p-10 bg-[#F4ECDD] rounded-[20px] flex flex-row-reverse justify-between md:flex-col">
        <div className="flex justify-end mb-5">
          <svg
            width="24"
            height="30"
        ...
        <div>
          <h2 className="text-lg mb-2">Total Transactions</h2>
          <h1 className="text-4xl font-bold">1,520</h1>
        </div>
      </div>

      <div className="md:w-1/4 p-5 md:p-10 bg-[#EFDADA] rounded-[20px] flex flex-row-reverse justify-between md:flex-col">
        <div className="flex justify-end mb-5">
          <Image src={likes} alt="likes.svg" />
        </div>
        <div>
          <h2 className="text-lg mb-2">Total Likes</h2>
          <h1 className="text-4xl font-bold">9,721</h1>
        </div>
      </div>

      <div className="md:w-1/4 p-5 md:p-10 bg-[#DEE0EF] rounded-[20px] flex flex-row-reverse justify-between md:flex-col">
        <div className="flex justify-end mb-5">
          <Image src={totalUsers} alt="totalUsers.svg" />
        </div>
        <div>
          <h2 className="text-lg mb-2">Total Users</h2>
          <h1 className="text-4xl font-bold">892</h1>
        </div>
      </div>
    </section>
  );
